...
function (_Component) {
  ...
  function ExportDataTable(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ExportDataTable).call(this, props));
    _this.state = {
  ...
  _createClass(ExportDataTable, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          ExportComponet = _this$props.ExportComponet,
          _getRows = _this$props.getRows,
          props = _objectWithoutProperties(_this$props, ["rows", "columns", "title", "actions", "ExportComponet", "getRows"]);
      ...
      return _react["default"].createElement("div", null, _react["default"].createElement(_DataTable["default"], _extends({}, props, {
        ...
        toolbar: _react["default"].createElement(_ToolBar["default"], {
          title: title,
          actions: [ExportComponet ? _react["default"].createElement(ExportComponet, {
            onClick: function onClick() {
              return (0, _utils.onExportCsv)({
                rows: _this2.state.exportedRows,
                columns: columns
              });
            }
          }) : null].concat(actions)
