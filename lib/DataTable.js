...
function getState(props) {
  ...
  var cols = (0, _clone2.default)(hasGroup ? prepareGroupColumns({ columns: columns, props: props }) : prepareColumns({ columns: columns, props: props }));
  ...
  _createClass(DataTable, [{
    ...
    value: function renderColumn(column) {
      ...
      return _react2.default.createElement(_fixedDataTable.Column, _extends({}, column, {
        ...
        footer: function footer(_ref7) {
          ...
          return _footer ? _react2.default.createElement(_Cell2.default, { column: column, row: _defineProperty({}, columnKey, _footer({ columnKey: columnKey, rows: rows })) }) : null;
        }
      }));
    }
  }, {
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['height', 'maxHeight']);
