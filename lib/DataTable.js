...
function getState(props) {
  ...
  var menuHeight = props.menuHeight || (count || exportCsv || title || actions ? 'auto' : props.menuHeight);
  return {
    columns: columns,
...
function (_Component) {
  ...
  _createClass(DataTable, [{
    ...
    key: "renderGroup",
    value: function renderGroup(_ref3) {
      var _this2 = this;

      var columns = _ref3.columns,
          label = _ref3.label,
          headerStyle = _ref3.headerStyle,
          props = _objectWithoutProperties(_ref3, ["columns", "label", "headerStyle"]);
      ...
      return _react["default"].createElement(_fixedDataTable.Column, _extends({}, column, {
        ...
        cell: function cell(_ref4) {
          var rowIndex = _ref4.rowIndex,
              cellProps = _objectWithoutProperties(_ref4, ["rowIndex"]);
    ...
    value: function renderColumns() {
      var _this$state3 = this.state,
          ...
          hasGroup = _this$state3.config.hasGroup;
