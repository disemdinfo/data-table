...
var DataTable = function (_Component) {
  ...
  function DataTable(props) {
    ...
    _this.state = {
      columns: _this.getColumns({ columns: columns }),
      startRows: rows
    };
  ...
  _createClass(DataTable, [{
    ...
    key: 'getColumns',
    value: function getColumns(params) {
      var columns = params.columns;

      var hasGroup = Object.keys(columns).some(function (key) {
        return columns[key].columns;
      });
      return (0, _clone2.default)(hasGroup ? prepareGroupColumns({ columns: columns, params: params }) : prepareColumns({ columns: columns, params: params }));
    }
  }, {
    key: 'getState',
    ...
    value: function onSearch(_ref5) {
      ...
      var data = this.getFilteredRows({ value: value, column: column });
