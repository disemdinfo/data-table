...
function prepareGroupColumns(c) {
  ...
  Object.keys(c).filter(function (key) {
    ...
    if (column.columns) {
      ...
      column = {
        columns: _defineProperty({}, key, prepareColumn(column, key))
      };
    }
...
function getState(props) {
  ...
  var columns = (0, _clone["default"])(hasGroup ? prepareGroupColumns(props.columns) : prepareColumns(props.columns));
  return {
    columns: columns,
...
function (_Component) {
  ...
  _createClass(DataTable, [{
    ...
    key: "renderGroup",
    value: function renderGroup(_ref2) {
      var _this2 = this;

      var columns = _ref2.columns,
          label = _ref2.label,
          headerStyle = _ref2.headerStyle,
          props = _objectWithoutProperties(_ref2, ["columns", "label", "headerStyle"]);
      ...
      return _react["default"].createElement(_fixedDataTable.Column, _extends({}, column, {
        ...
        cell: function cell(_ref3) {
          var rowIndex = _ref3.rowIndex,
              cellProps = _objectWithoutProperties(_ref3, ["rowIndex"]);
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_Container["default"], _extends({}, props, {
        ...
        return _react["default"].createElement(_fixedDataTable.Table, _extends({}, _this4.props, {
          width: width,
          rowsCount: _this4.state.rows.length,
