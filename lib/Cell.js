...
var TableCell = function TableCell(_ref2) {
  var column = _ref2.column,
      row = _ref2.row,
      props = _objectWithoutProperties(_ref2, ['column', 'row']);

  var _onClick = column.onClick || props.onClick;
  var value = (0, _utils.cellRenderer)({ column: column, row: row });
  return _react2.default.createElement(
    _fixedDataTable.Cell,
    _extends({}, props, {
      style: getStyle(_extends({ column: column, row: row, value: value, onClick: _onClick }, props)),
